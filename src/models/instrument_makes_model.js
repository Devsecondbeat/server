...
const createInstrumentAds = async (req, res) => {
    try{
        ...
        const { user_id, make_id, name, description, price, condition } = req.body;
        await pool.query('Insert into used_instrument_ads (user_id, make_id, name, description, price, condition) values($1, $2, $3, $4, $5, $6) returning *', [user_id, make_id, name, description, price, condition], (error, results) => {
...
const updateInstrumentAds = async (req, res) => {
    try{
        ...
        await pool.query('update used_instrument_ads set description = $2, price = $3, condition = $4 where id = $1 ', [ad_id, description, price, condition], (error, results) => {
            if (error) {throw error}
...
const deleteInstrumentAds = async (req, res) => {
    try{
        ...
        await pool.query('delete from used_instrument_ads where id = $1 ', [ad_id], (error, results) => {
            if (error) {throw error}
